...
var file_sso_sso_proto_rawDesc = []byte{
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x36, 0x0a, 0x07, 0x49, 0x73, 0x41, 0x64, 0x6e, 0x69,
	...
	0x5a, 0x15, 0x63, 0x69, 0x72, 0x6e, 0x6f, 0x66, 0x61, 0x67, 0x2e, 0x73, 0x73, 0x6f, 0x2e, 0x76,
...
var file_sso_sso_proto_depIdxs = []int32{
	...
	4, // 2: auth.Auth.IsAdnin:input_type -> auth.IsAdminRequest
	1, // 3: auth.Auth.Register:output_type -> auth.RegisterResponse
	3, // 4: auth.Auth.Login:output_type -> auth.LoginResponse
	5, // 5: auth.Auth.IsAdnin:output_type -> auth.IsAdminResponse
